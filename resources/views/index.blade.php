...
/*** Footer End ***/
    ...
    <div class="container-fluid fixed-top">
        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                    ...
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7">
                                <h1 class="display-2 mb-5 animated slideInDown text-white">Framer's Paddy Market Place</h1>
                                    <a href="/add-paddy" class="btn btn-primary rounded-pill py-sm-3 px-sm-5">Products</a>
                                    <a href="/about" class="btn btn-secondary rounded-pill py-sm-3 px-sm-5 ms-3">Services</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="carousel-item">
                    <img class="w-100" src="img/rice2.jpg" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7">
                                    <h1 class="display-2 mb-5 animated slideInDown text-white">The best price for your paddy.</h1>
        ...
        <div class="container-fluid featurs py-5">
            <div class="container py-5">
                ...
                <h5>Best Price</h5>
        <p class="mb-0">Guaranteed competitive pricing</p>
        </div>
        </div>
        </div>
                <div class="col-md-6 col-lg-3">
    ...
    <div class="featurs-item text-center rounded bg-light p-4">
        ...
        <div class="featurs-content text-center">
            <h5>Best Platform</h5>
            <p class="mb-0">Trusted by farmers</p>
        </div>
    </div>
</div>
                    <div class="col-md-6 col-lg-3">
        ...
        <div class="product-card">
            ...
            <div class="product-content">
                ...
                <div class="price-order">
                    ...
                    <a href="#" class="order-btn"><i class="fa fa-receipt"></i> Order Now</a>
                </div>
            </div>
        </div>
                        ...
                        <div class="p-4 rounded bg-light">
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    ...
                                    <a href="#" class="btn border border-secondary rounded-pill px-2 text-primary"><i class="fa fa-receipt me-2 text-primary"></i> Order Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
