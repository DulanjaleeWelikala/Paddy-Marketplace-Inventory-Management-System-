  ...
  <div class="main-content">
    <div class="page-title">
     ...
     <div class="table-card">
      ...
      <div class="container">
    <h2>📦 Stock Manager - Pending Orders</h2>
    ...
    <table border="1" cellpadding="10">
        ...
        <tr>
            ...
            <td>
                <form action="{{ route('stock_manager.orders.approve', $order->id) }}" method="POST">
                    @csrf
                    <button type="submit">✅ Approve & Generate Invoice</button>
                </form>
            </td>
        </tr>
        @endforeach
